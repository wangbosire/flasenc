...
export const AuditAction = {
  ...
  /** 平台管理员直接编辑内容发布/上架权限字段。 */
  PLATFORM_CONTENT_PERMISSION_UPDATE: 'PLATFORM_CONTENT_PERMISSION_UPDATE',
  /** 平台管理员从后台发起内容审核入队。 */
  PLATFORM_CONTENT_SUBMIT_MODERATION: 'PLATFORM_CONTENT_SUBMIT_MODERATION',
  ...
  /** 平台管理员创建管理后台菜单项。 */
  ADMIN_MENU_ITEM_CREATE: 'ADMIN_MENU_ITEM_CREATE',
  /** 平台管理员更新管理后台菜单项。 */
  ADMIN_MENU_ITEM_UPDATE: 'ADMIN_MENU_ITEM_UPDATE',
  /** 平台管理员批量调整管理后台菜单排序或父级。 */
  ADMIN_MENU_ITEM_REORDER: 'ADMIN_MENU_ITEM_REORDER',
  /** 平台管理员删除管理后台菜单项。 */
  ADMIN_MENU_ITEM_DELETE: 'ADMIN_MENU_ITEM_DELETE',
} as const;
